# Agent Instructions — bootstrap-new fixture

This fixture represents a project produced by `bootstrap_project.sh --new`.
It is used by SCN-D-03 to verify that the first agent session in a
bootstrapped repo has the Astaire CLI surface and the "When and How" block
loaded in context.
