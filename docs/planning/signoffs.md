...
| Phase 8.2 — P10 Universal Adoption + CockpitVM Embedded Style | pending | Accountable Delivery Lead (approver: Chairperson — critical tier per `core/AUTONOMOUS_DELIVERY_GOVERNANCE.md`) | 0.0215 | 4.25 | Pool: `docs/planning/pool_questions/phase-8.2-style-adoption.md`; chunks: `docs/planning/chunks/phase-8.2-chunks.md`; risks: `docs/planning/phase-8.2-risks.md`; TO-DO: `docs/planning/phase-8.2-todo.md`. Sign-off recorded at SCN-8.2.5. |
