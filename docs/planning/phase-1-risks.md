...
| R-3 | Astaire `v0.3.0` tag dependency outside this repo's control | 2026-04-20 | Astaire `v0.3.0` published and governance `v0.6.0` repinned to the released tag/commit `a17d8b4`. Evidence: `docs/releases/astaire/v0.3.0-bundle.md`. |
