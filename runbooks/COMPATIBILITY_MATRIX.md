...
|--------------------|------------------------|--------------------|---------------|
| v0.6.0             | strict                 | Yes (adds `graphify` manifest object with promotion/import knobs, routing grammar, validation script, strict Astaire L0 routing, and the consumer bootstrap release branch model) | `astaire` @ `v0.3.0` (`a17d8b4`); `graphify` @ `v1.0.0` (`0a31c08`) |
