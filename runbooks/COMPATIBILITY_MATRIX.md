...
|--------------------|------------------------|--------------------|---------------|
| v0.6.0             | strict                 | Yes (adds `graphify` manifest object with promotion/import knobs, routing grammar, validation script, and strict Astaire L0 routing) | `astaire` @ `v0.2.3` (`f6b6b83`); `graphify` @ `v1.0.0` (`0a31c08`) |
